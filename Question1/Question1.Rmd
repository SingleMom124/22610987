...
```{r Figure2, echo=FALSE, fig.align='center', fig.cap="Top 5 Male Names Over Time.\\label{Figure2}", fig.ext='png', fig.height=4, fig.width=6, warning=FALSE}
...
```{r Figure3, echo=FALSE, fig.align='center', fig.cap="Top 5 Male Names Over Time.\\label{Figure3}", fig.ext='png', fig.height=4, fig.width=6, warning=FALSE}
